...
import com.iitms.bfr.data.DeliveryStatus
...
import com.iitms.bfr.ui.adapter.OrderCartAdapter
import com.iitms.bfr.ui.adapter.OrderLifeCycleAdapter
                ...
                if (it.order!!.orderLifeCycleStatus != null && it.order!!.orderLifeCycleStatus!!.isNotEmpty()) {
                    ...
                    for (cycle in it.order!!.orderLifeCycleStatus) {
                        if (cycle.status != DeliveryStatus.Completed.value) {
                            status = true
                            binding.btnDeliveredOrder.visibility = View.GONE
                            break
                        }
                    }
