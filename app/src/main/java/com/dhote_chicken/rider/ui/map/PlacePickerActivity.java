package com.dhote_chicken.rider.ui.map;
...
public class PlacePickerActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        latLng2 = new LatLng(Double.parseDouble(getIntent().getStringExtra("Latitude")), Double.parseDouble(getIntent().getStringExtra("Longitude")));
        getIntentData();
        initViews();
    }
    ...
    private void initViews() {
        ...
        CardView mBtnSelectAddress = findViewById(R.id.btnSelectAddress);
        ImageView mBtnCurrentLocation = findViewById(R.id.ivCurrentLocation);

        mBtnSelectAddress.setOnClickListener(v -> {
            if (addresses != null) {
                ...
                editor.putString("Address", String.valueOf(fullAddress));
                editor.commit();
                editor.apply();
                onBackPressed();
            }
